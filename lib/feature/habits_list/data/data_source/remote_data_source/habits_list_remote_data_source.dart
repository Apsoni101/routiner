...
abstract class HabitsListRemoteDataSource {
...
class HabitsListRemoteDataSourceImpl
    implements HabitsListRemoteDataSource {
  ...
  Future<Either<Failure, String>> _getLogsCollectionPath(
    ...
    return userIdResult.fold(
      Left.new,
          (final String userId) => Right(
        'users/$userId/custom_habits/$habitId/logs',
      ),
    );
  }
  ...
  Future<Either<Failure, Unit>> saveLog({
    ...
    if (log.date == null || log.date!.isEmpty) {
      return const Left(
        Failure(message: 'Log date is required'),
      );
    }
    ...
    return pathResult.fold(
      Left.new,
        ...
        return result.fold(
          ...
          data == null ? const Right(null) : Right(
            HabitLogHiveModel.fromJson(data),
          ),
        );
      },
    );
      ...
      Left.new,
        ...
        return result.fold(
          Left.new,
            ...
            data.map(HabitLogHiveModel.fromJson).toList(),
          ),
        );
      },
    );
