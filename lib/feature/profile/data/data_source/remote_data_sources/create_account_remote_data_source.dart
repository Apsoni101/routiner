// lib/feature/profile/data/data_source/create_account_remote_data_source.dart
...
/// Abstract create account remote data source
...
/// Implementation of create account remote data source using Firestore
class CreateAccountRemoteDataSourceImpl
  ...
  /// Get custom habits collection path
  ...
  Future<Either<Failure, Unit>> saveAccountData({
    ...
    // First, save gender to user document
    final Either<Failure, String> userDocPathResult = await _getUserDocPath();

    final Either<Failure, Unit> genderResult =
    await userDocPathResult.fold<Future<Either<Failure, Unit>>>(
    ...
    return habitsCollectionPathResult
        ...
        for (final CustomHabitModel habit in habits) {
          ...
          // If any habit save fails, return the failure
          if (result.isLeft()) {
            return result;
          }
        }
  ...
  Future<Either<Failure, Map<String, dynamic>>> getAccountData() async {
    ...
    return userDocPathResult.fold<Future<Either<Failure, Map<String, dynamic>>>>(
        ...
        return firestoreService.request<Map<String, dynamic>>(
          ...
          responseParser: (final dynamic data) => data as Map<String, dynamic>,
          docId: userDocPath.split('/').last,
        );
      },
    );
